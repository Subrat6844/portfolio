        ...
        <div className="flex items-center justify-between h-16">
          <Link href="/" className="group">
            <motion.span
              ...
              className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-primary to-accent group-hover:opacity-80 transition-opacity"
            >
              Subrat Chaudhary
            </motion.span>
          </Link>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-background/80 backdrop-blur-md">
              ...
              <Button className="w-full bg-primary hover:bg-primary/90 mt-2">Download CV</Button>
            </div>
          </motion.div>
        )}
      </AnimatePresence>
