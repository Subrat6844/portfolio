...
const projects = [
  ...
  },
  {
    ...
    description: "Collaborative task management platform with real-time updates and team workspace features",
    image: "/placeholder.svg?height=400&width=600",
    liveLink: "#",
    githubLink: "#",
  ...
  },
  {
    ...
    description: "Real-time chat application with AI-powered features and multi-language support",
    image: "/placeholder.svg?height=400&width=600",
    liveLink: "#",
    githubLink: "#",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2">
          {projects.map((project) => (
            <Card
              key={project.title}
              className="bg-muted border-muted-foreground/20 overflow-hidden group hover:border-primary/50 transition-all duration-300"
            >
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tech.map((tech) => (
                      <Badge key={tech} variant="secondary" className="bg-secondary text-primary hover:bg-secondary/80">
                        {tech}
                      </Badge>
                    ))}
                  </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-2">
                    {project.tools.map((tool) => (
                      <Badge key={tool} variant="outline" className="border-accent/50 text-accent hover:bg-accent/10">
                        {tool}
                      </Badge>
                    ))}
                  </div>
